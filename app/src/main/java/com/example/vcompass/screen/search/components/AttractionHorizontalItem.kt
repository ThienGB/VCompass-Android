        ...
        Box(
            ...
            Row {
                Box(
                    ...
                    CoreImage(
                        source = CoreImageSource.Url(attraction.getFirstImage()),
                ...
                Column(
                    ...
                    attraction.totalRatings?.let {
                        if (it > 0)
                            Row(
                                ...
                                CoreText(
                                    text = attraction.averageRating.toString(),
                                    style = CoreTypography.displaySmall,
                                )
                                ...
                                CoreText(
                                    text = stringResource(
                                        ...
                                        attraction.totalRatings.toString()
                                    ),
                                    style = CoreTypography.displaySmall,
                                    color = MyColor.TextColorLight
                                )
                    ...
                    Row(
                        ...
                        CoreText(
                            text = attraction.price?.formatThousandK(),
